...
class Social(models.Model):
    ...
    image = models.ImageField(verbose_name='图片', height_field='image_height', width_field='image_width', upload_to='images/social')
...
class BloggerInfo(models.Model):
    ...
    background = models.ImageField(verbose_name='背景', upload_to='images/background', default='images/background/background.jpeg')
    social = models.ManyToManyField(Social, verbose_name='社交平台')
